...
{
public:
	YellowTowerBase(int leftX, int leftY, int tileSize, int _builtRound, int _value, int _tileSize);
...
YellowTowerBase::YellowTowerBase( int leftX, int leftY, int tileSize, int _builtRound, int _value, int _tileSize)
